...
public class NotificationController {
    ...
    public String save(
        ...
        if (notification.getTitle() == null || notification.getTitle().trim().isEmpty()
            ...
            model.addAttribute("message", "Tiêu đề và nội dung không được để trống.");
            model.addAttribute("notification", notification);
            setCommonModelAttributes(model);
            return "notification-form";
        }
        ...
        if (notification.getEventDatetime() == null) {
            model.addAttribute("message", "⚠ Thời gian tổ chức không được để trống.");
            model.addAttribute("notification", notification);
            setCommonModelAttributes(model);
            return "notification-form";
        }
        if (notification.getEventLocation() == null || notification.getEventLocation().trim().isEmpty()) {
            model.addAttribute("message", "Địa điểm không được để trống.");
            model.addAttribute("notification", notification);
            setCommonModelAttributes(model);
            return "notification-form";
        }
